"""
Create a 250-question high-disagreement MedMCQA dataset.
...
Output
------
- data/filtered/medmcqa_250q_high_disagreement.json
...
OUTPUT_PATH = DATA_DIR / "medmcqa_250q_high_disagreement.json"
...
def main() -> None:
    ...
    print("="*70)
    print("CREATING MEDMCQA 250Q HIGH-DISAGREEMENT DATASET")
    print("="*70)
